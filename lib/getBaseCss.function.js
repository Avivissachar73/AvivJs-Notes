...
function getBaseCssAndHelpers(baseSelector = '', emUnit = 16, smallScreenBreakPxVal = '900px') {
  ...
  const baseLayoutCss = elementService.dataToCss(baseSelector, {
    '*': {
    ...
    // @media (max-width: $big-screen-breake) {
    //   .container {
    //       max-width: 1200px;
    //   }
    // } @media (max-width: $medium-screen-breake) {
    //   .container {
    //       padding: 10px 24px;
    //       max-width: unset;
    //   }
