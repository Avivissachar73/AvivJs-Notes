...
export class BaseDataChart extends BaseChart {
  ...
  get textStyle() {
    return { strokeStyle_: 'black', fillStyle: 'black', fontWeight: '600', fontFamily: 'sans-serif', size: 40, ...(this.chartData.style || {}) };
  }
...
export class PiChart extends BaseDataChart {
  constructor(chartData = getBasePieChartData(), ...args) {
    super(chartData, ...args);
  }
  ...
  getCahrtDataToRender() {
    ...
    return [
      ...
      ...chartData.data.map((curr, idx) => {
        ...
        return {
          ...this.baseCircleItem,
          w: this.baseCircleItem.w - this.strokeLineWidth,
          h: this.baseCircleItem.h - this.strokeLineWidth,
...
export class DonatChart extends PiChart {
  ...
  getCahrtDataToRender() {
    return [
      ...
      { ...this.centerCircle, style: { strokeStyle: this.chartData.style?.strokeStyle || 'white', lineWidth: this.strokeLineWidth } }
    ]
  }
}
