const { elementService } = require("./element.service.js");
const { range } = require("../utils.service.js");
...
function getBaseCssAndHelpersWrapped() {
  return elementService.StyleElWrapper(getBaseCssAndHelpers());
}
