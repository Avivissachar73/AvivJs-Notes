...
export class AnimatedLoader {
  negative = false;
  destroyCanvas = null;
  animationInterval = null;
  constructor(selector = '.animated-loader-container') {
  ...
  init() {
    ...
    const canvasService = new CanvasService(board, { selector:  this.selector, enableAnimation: true }, (shape, drawOpts, context, service) => {
